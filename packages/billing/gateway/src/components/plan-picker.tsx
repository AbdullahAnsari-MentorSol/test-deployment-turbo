        ...
        >
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div>
                                <If condition={product.name !== 'Enterprise'}>
                                  <Price key={plan.id}>
                                    <span>
                                      {formatCurrency({
                                        currencyCode:
          ...
          <div>
            <Button
              ...
              disabled={props.pending || !form.formState.isValid || (selectedProduct?.name && selectedProduct.name === 'Enterprise')}
    ...
    >
      ...
      <If condition={selectedPlan.lineItems.length > 0}>
        ...
        <div className={'flex flex-col space-y-2'}>
          ...
          <If condition={selectedProduct.name !== 'Enterprise'}>
            <LineItemDetails
