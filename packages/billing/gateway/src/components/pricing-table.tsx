    ...
    >
      ...
      <div className={'flex flex-col space-y-6'}>
        ...
        <div className={'flex flex-col space-y-2'}>
          <If condition={props.product.name !== 'Enterprise'}>
          ...
          <If condition={props.product.name === 'Enterprise'}>
            ...
            >
              <span
                className={
                  'font-heading flex items-center text-2xl font-semibold tracking-tighter'
                }
              >
          ...
          <If
            condition={props.plan.name && props.product.name !== 'Enterprise'}
          >
            <span
              className={cn(
